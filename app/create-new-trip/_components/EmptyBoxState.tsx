...
function EmptyBoxState({onSelectOption}:any) {
  return (
    <div className='mt-7'>
        ...
        <p className='text-center text-gray-400 mt-2'>Discover personalized travel itenaries. find the best destinations, and plan your dream vacation effortlessly with the power of AI. let our smart assistant do the hard work while you enjoy the journey.</p>
